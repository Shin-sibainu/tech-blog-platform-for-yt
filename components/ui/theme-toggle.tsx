...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200/60 bg-white/80 text-gray-700 backdrop-blur-sm transition-all duration-200 hover:bg-gray-50 hover:scale-105 active:scale-95"
